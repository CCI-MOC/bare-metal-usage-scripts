...
def _get_running_time(
    ...
    start_time: datetime,
    end_time: datetime,
    excluded_intervals: list[tuple[datetime, datetime]] = None,
) -> int:
    ...
    return math.ceil(total_interval_duration / 3600)
...
def get_project_invoices(
    ...
    start_time: datetime,
    end_time: datetime,
    excluded_time_ranges: list[tuple[datetime, datetime]] = None,
